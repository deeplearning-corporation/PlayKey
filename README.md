...
<h1>PlayKey<h1></h1>
<h3></h3>使用 PyGame 与 Microsoft Visual C++ 开发的一款游戏<h3></h3>
...
## 源代码编译
此 GitHub 仓库提供的源代码是 PlayKey 1.0.0 Release 的源代码
编译所需：
- Python
- PyInstaller
...
## 贡献者
- OmegeUOS (BiliBili UP)
- 杜雨本雨  (BiliBili UP)
- 梦见你从有到无 (BiliBili UP)
- 一片里脊肉 (BiliBili UP)

## 贡献
如果您想为我们 PlayKey 游戏做贡献，你可以：
- 加入 QQ 群：945327942

## 致谢
感谢您阅读 PlayKey 游戏的 README！
